...
static struct l2_level l2_freq_tbl[] __initdata = {
    ...
    [18] = { { 1296000, HFPLL, 1, 0x32 }, 1150000, 1150000, 5 },
    [19] = { { 1350000, HFPLL, 1, 0x34 }, 1175000, 1175000, 5 },
#endif
	{ }
};
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
    ...
    { 1, {   288000, HFPLL, 2, 0x20 }, L2(0),   700000 },
    { 1, {   333000, HFPLL, 2, 0x22 }, L2(0),   725000 },
	...
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(L2_OC_IDX), 1175000 },
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	...
	{ 1, {  1026000, HFPLL, 1, 0x28 }, L2(5),  875000 },
